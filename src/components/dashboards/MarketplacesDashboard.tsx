...
export default function MarketplacesDashboard({ userEmail, onLogout, darkMode, onToggleDarkMode }: MarketplacesDashboardProps) {
  ...
  const menuItems = [
    ...
    { id: 'golpista', label: 'Vendedores Golpistas', icon: AlertOctagon, action: () => setActiveModal('golpista') },
    { id: 'produtofalso', label: 'Produtos Falsos', icon: Package, action: () => setActiveModal('produtofalso') },
